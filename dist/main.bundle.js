...
/* WEBPACK VAR INJECTION */(function(__dirname) {const { app, BrowserWindow } = __webpack_require__(/*! electron */ "electron")
let { fork } = __webpack_require__(/*! child_process */ "child_process")
let findOpenSocket = __webpack_require__(/*! ./find-open-socket */ "./src/main/find-open-socket.js")
let isDev = __webpack_require__(/*! electron-is-dev */ "./node_modules/electron-is-dev/index.js")
...
function createBackgroundWindow(socketName) {
  ...
  // win.loadURL(`file://src/server${__dirname}server-dev.html`)
  win.loadURL(__dirname + `../server/server-dev.html`)
